...
def generate_square_boundaries(top_left, bottom_right, boundary_subsampling_factor=1):
	x_l, y_t = top_left
	...
	# return boundary
	return torch.cat([top_line, right_line, bottom_line, left_line], dim=1).type(torch.LongTensor).T[::boundary_subsampling_factor, ...]
